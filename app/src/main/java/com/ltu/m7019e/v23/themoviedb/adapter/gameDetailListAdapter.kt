...
//
//class gameDetailAdapter() : ListAdapter<Game, gameDetailAdapter.ViewHolder>(GameDetailDiffCallback()) {
//
//    class ViewHolder(private val binding: GameDetailBinding) : LinearLayout.ViewHolder(binding.root) {
//
//
//        fun bind(game: Game) {
//            binding.game = game
...
//
//
//    class GameDetailDiffCallback : DiffUtil.ItemCallback<Game>() {
